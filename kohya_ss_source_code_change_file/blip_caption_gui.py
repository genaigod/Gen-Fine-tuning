...
def blip_captions_api(
    ...
    try:
        import json
        caption_images(train_data_dir, caption_file_ext,batch_size,num_beams,top_p,max_length,min_length,beam_search,prefix,postfix)
    except Exception as e:
        return json.dumps({'code': 20002, "msg": str(e)})

    return json.dumps({'code': 20000, "msg":""})
###
# Gradio UI
###
...
def gradio_blip_caption_gui_tab(headless=False, default_train_dir=None):
    ...
    with gr.Tab("BLIP Captioning"):
        ...
        gr.Interface(fn=blip_captions_api, inputs=[
                train_data_dir,
                caption_file_ext,
                batch_size,
                num_beams,
                ...
                prefix,
                postfix,
            ], outputs="text", api_name="blip_captions_api")
